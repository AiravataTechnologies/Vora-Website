...
//             <p className="text-sm sm:text-base lg:text-lg font-semibold text-slate-700 mb-4 tracking-widest uppercase opacity-80 transform translate-y-4 animate-[fadeInUp_0.6s_ease-out_0.4s_forwards]">
//               ABOUT US
//             </p>
...
//               Company
//             </h1>
//             <p className="text-slate-700 text-sm sm:text-base lg:text-lg leading-relaxed font-normal max-w-2xl transform translate-y-8 animate-[fadeInUp_1s_ease-out_0.8s_forwards]">
...
//             <p className="text-slate-700 text-sm sm:text-base lg:text-lg leading-relaxed font-normal max-w-2xl transform translate-y-4 animate-[fadeInUp_0.8s_ease-out_1.4s_forwards]">
...
//                     </svg>
//                   </div>
//                   <span className="text-slate-800 font-medium text-xs sm:text-sm leading-tight group-hover:text-slate-900 transition-colors duration-300">
...
//               <button className="inline-flex items-center gap-2 pl-4 pr-6 py-3 border-2 border-slate-800 rounded-full hover:bg-slate-800 hover:text-white hover:border-slate-800 transition-all duration-300 text-sm sm:text-base font-medium text-slate-800 group hover:scale-105 hover:shadow-lg">
            ...
            <div className="transform translate-y-6 animate-[fadeInUp_0.8s_ease-out_1.6s_forwards]">
              ...
              <div className="flex flex-wrap gap-6 lg:gap-8 mb-3">
                <div className="flex items-center space-x-2 group cursor-pointer transform opacity-0 animate-[slideInFade_0.6s_ease-out_1.8s_forwards] hover:scale-105 transition-transform duration-300">
                  ...
                  <span className="text-black font-medium text-xs sm:text-sm leading-tight group-hover:text-slate-800 transition-colors duration-300">
                    Trusted by leading<br />brands since 1963
                  </span>
                </div>
