...
// About Page Header Section Component - Fixed mobile spacing
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-7xl">
            <div className="text-center">
                <div className="flex justify-center mb-4 sm:mb-6">
                    {/* Company Logo Image */}
                    {/* <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-white rounded-full flex items-center justify-center shadow-lg overflow-hidden transform hover:scale-110 transition-all duration-500">
                        <img
                            src={logoPath}
                            alt="Company Logo"
                            className="w-full h-full object-contain p-1.5 sm:p-2 transition-transform duration-300"
                        />
                    </div> */}
                </div>
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-7xl font-bold mb-3 sm:mb-4 text-slate-800 animate-slide-down">About Us</h1>
